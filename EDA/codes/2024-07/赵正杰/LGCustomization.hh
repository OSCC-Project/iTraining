...
struct cu_RollbackInfo
{
  cu_RollbackInfo() : is_dirty(false) {}
  ~cu_RollbackInfo() = default;
...
class LGCustomization : public LGMethodInterface
{
 ...
 private:
  ...
  std::stack<cu_RollbackInfo> _rollback_stack;
  ...
  void splitTargetInst(ipl::LGInstance* inst, cu_RollbackInfo& rollback_info);
