...
{
 public:
  TetrisCluster() = default;
  explicit TetrisCluster(std::string name);

  TetrisCluster(const TetrisCluster& other)
  {
    _name = other._name;
  ...
  TetrisCluster(TetrisCluster&& other)
  {
  ...
  TetrisCluster& operator=(const TetrisCluster& other)
  {
    _name = other._name;
    _inst_list = other._inst_list;
    _belong_segment = other._belong_segment;
  ...
  TetrisCluster& operator=(TetrisCluster&& other)
  {
    _name = std::move(other._name);
    _inst_list = std::move(other._inst_list);
    _belong_segment = std::move(other._belong_segment);
  ...
  void updateTetrisInfo();
  void insertInstance(ipl::LGInstance* inst);
  void appendCluster(TetrisCluster& cluster);
